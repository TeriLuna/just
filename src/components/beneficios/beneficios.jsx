...
export const Beneficios = () => {
  return (
    <section id="beneficios" className="relative p-56 sm:py-0">
      ...
      <div className="contBenf">
        <div className="benef">
          <div className="contBenefIcon">
            <img
              className="benefIcon"
              src={require("../../assets/images/icons/beneficios.png")}
              alt=""
            />
          </div>
          <div className="benefItem">
            <img
              ...
              alt=""
            />
            <p className="text-l titleBenef">
              Obten ganacias del 25-30% del volumen de tus ventas
            </p>
          </div>
          <div className="benefItem">
            <img
          ...
          <div className="benefItem">
            <img
              ...
              alt=""
            />
            <p className="text-l titleBenef">Emprendimiento</p>
          </div>
          <div className="benefItem">
            <img
              className="checkIcon"
            ...
            />
            <p className="text-l titleBenef">
              Puedes hacer carrera de liderazgo
            </p>
          </div>
          <div className="benefItem">
            <img
              ...
              alt=""
            />
            <p className="text-l titleBenef">Premios</p>
          </div>
          <div className="benefItem">
            <img
              className="checkIcon"
              ...
              alt=""
            />
            <p className="text-l titleBenef">Viajes</p>
          </div>
          <div className="benefItem">
            <img
              className="checkIcon"
              ...
              alt=""
            />
            <p className="text-l titleBenef">Productos Just de regalo</p>
          </div>
        </div>
